...
FPS = 60
PATH = [(173, 125), (120, 72), (62, 123), (70, 478), (325, 731), (401, 682), (411, 532), (510, 477), (597, 551), (627, 714), (732, 705), (736, 417), (685, 361), (437, 354), (401, 307), (437, 258), (693, 255), (740, 199), (718, 81), (326, 74), (281, 122), (278, 370), (200, 380), (177, 258)]
...
class ComputerCar(AbstractCar):
    ...
    def __init__ (self, max_vel, rotational_vel, path=[]):
        super().__init__(max_vel, rotational_vel)
        self.path = path
    ...
    def calculate_angle(self):
        ...
        if difference_in_angles > 0:
            self.angle -= min(self.rotation_vel, abs(difference_in_angles))
        else:
            self.angle += min(self.rotation_vel, abs(difference_in_angles))
...
def draw(win, images, player_car, computer_car, game_info):
    ...
    win.blit(vel_text, (10, HEIGHT - vel_text.get_height() - 15))
